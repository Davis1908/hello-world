define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	function stiatExtension(options)
	{
		...
		var stiatObj = 
		{
			...
			attribute2 : 
			{
				name : 'Attachment', //Attribute name to be used for feedback and logging
				title : {
			...
			'Press the other key ("E" or "I") to continue.<p/>',
			...
			instTemplateCategoryRight : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'and for items that belong to the category <font color="#191970">thecategory</font>.<br/>' + 
				'Items will appear one at a time.<br/><br/>' + 
				'If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. ' + 
				'Press the other key to continue.<br/><br/>' + 
				'<p align="center">Press the <b>space bar</b> when you are ready to start.</font></p></div>', 
